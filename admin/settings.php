...
if(isset($_POST['form5'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE tbl_settings SET total_recent_post_footer=?, total_popular_post_footer=?, total_recent_post_sidebar=?, total_popular_post_sidebar=?WHERE id=1");
    $statement->execute(array($_POST['total_recent_post_footer'],$_POST['total_popular_post_footer'],$_POST['total_recent_post_sidebar'],$_POST['total_popular_post_sidebar']));
